# 🚀 JABARDAILY.ID - Integrasi Google Sheets sebagai CMS

**Gunakan Google Sheets sebagai database artikel untuk website JabarDaily.id. Generator otomatis membuat HTML dan memperbarui konten dengan mudah!**
...
# 1. Buat project (misal: "JabarDaily.id-News")
